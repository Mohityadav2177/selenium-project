...
4. Configure a new user account on the device with the command username hfcl privilege 1 password unencrypted  Discover@1234.
5.Establish an telnet session to the device using the credentials of user hfcl for User EXEC Mode
...
9.configure one more user  username palc privilege 1 password unencrypted  Discover@1234  and Verify Multiple users login
